...
!!! tip "VectorBT PRO"
    ...
    Additional indicators include the [Hurst exponent](https://vectorbt.pro/features/indicators/technical-indicators/#hurst-exponent)
    and [Smart Money Concepts](https://vectorbt.pro/features/indicators/technical-indicators/#smart-money-concepts).
    [Streaming indicators](https://vectorbt.pro/features/indicators/streaming-indicators/#streaming-indicators)
